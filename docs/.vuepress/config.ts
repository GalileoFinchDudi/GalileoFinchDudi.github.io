...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: "学习笔记📒",
        link: "/learnnotes/", //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
      },
      {
        text: "读书笔记📚",
        link: "/readnotes/", //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
      },
      { text: "关于", link: "/about/" },
      {
        text: "索引",
    ...
    bodyBgImg: [
      "https://pics.galileofinch.top/imgs/TabascoEyes__a_dramatic_scene_from_1952_Soviet_version_of_Star__438c2768-8a9e-44b8-a6d1-3aa748ba8b05.png",
  ...
  head: [
    ...
    [
      "link",
      { rel: "icon", href: "https://pics.galileofinch.top/imgs/logo.png" },
